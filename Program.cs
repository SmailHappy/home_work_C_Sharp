...
void Run() // Выбор задачи
{
    ...
    Console.WriteLine("Д/з - 1. Задача 2 - 2. Задача 4 - 4. Задча 6 - 6. Задача 8 - 8.\n"
                    + "Д/з - 2. Задача 10 - 10. Задача 13 - 13. Задача 15 - 15.\n"
                    + "Д/з - 3. Задача 19 - 19. Задача 21 - 21. Задача 23 - 23. Задача * - 01. Задача ** - 02.\n"
                    + "Д/з - 4. Задача 25 - 25. Задача 27 - 27. Задача 29 - 29. Задача * - 03. Задача ** - 04.\n"
